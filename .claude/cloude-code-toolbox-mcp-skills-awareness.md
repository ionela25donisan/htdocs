...
_Generated: 2026-05-21T14:28:45.637Z_
...
Workspace `mcp.json` _(folder: htdocs)_

- **c:\xampp1\htdocs\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Ionela\.claude.json** — _File exists — no servers defined_
